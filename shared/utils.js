...
/*
window.gltfLoader.load("https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/Box/glTF/Box.gltf", function(gltf) {
  const rover = gltf.scene.children.find(c => c.name == 'Box')
...
window.gltfLoader.load( 'animation2.glb', function (gltf){
...
function animate() {
  ...
  //console.log("animTime: "+animationTime+" timescale: "+mixer.timeScale + " nextTimeStop: "+nextTimeStop);
